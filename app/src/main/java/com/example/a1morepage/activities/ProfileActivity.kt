...
import com.example.a1morepage.adapters.AdapterPdfFavorite
        ...
        ref.child(firebaseAuth.uid!!)
            .addValueEventListener(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    val formattedDate = Operations.formatTimestamptToDate(timestamp.toLong())
